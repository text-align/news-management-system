...
$data=new database();
$data->get_connection();
mysqli_query($conn,"delete from review where news_id=$news_id");
mysqli_query($conn,"delete from news where news_id=$news_id");
$data->close_connection();
$message = "新闻及相关评论信息删除成功！";
echo ("<script type='text/javascript'>alert('删除成功！');window.location.href='index.php?url=news_list.php';</script>");
?>
